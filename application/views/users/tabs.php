                    ...
                    <div class="widget-tabs-int">
                        <div class="widget-tabs-list">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#home">Lab Admin</a></li>
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    <!-- flot JS
		============================================ -->
    <script src="<?php echo base_url(); ?>assets/js/flot/flot-widget-anatic-active.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/flot/chart-tooltips.js"></script>
