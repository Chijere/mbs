...
<body>
    ...
    <div class="invoice-print">
        <a href="<?php echo base_url(); ?>assets/#" class="btn" data-ma-action="print"><i class="notika-icon notika-print"></i></a>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="footer-copy-right">
                        <p>Copyright © 2018 
. All rights reserved. Template by <a href="<?php echo base_url(); ?>assets/https://colorlib.com">Colorlib</a>.</p>
                    </div>
                </div>
            </div>
        </div>
